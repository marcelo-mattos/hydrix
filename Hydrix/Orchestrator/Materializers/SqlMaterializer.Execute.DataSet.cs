...
namespace Hydrix.Orchestrator.Materializers
{
        ...
        Contract.ISqlMaterializer
    {
            ...
            object parameters)
        {
            ...
            using (var dataTable = (this as Contract.ISqlMaterializer).ExecuteTable(
                sql,
                parameters))
            {
        ...
        {
            using (var dataTable = await (this as Contract.ISqlMaterializer).ExecuteTableAsync(
                sql,
                parameters,
                cancellationToken)
            ...
            where TDataParameterDriver : IDataParameter, new()
        {
            ...
            using (var dataTable = (this as Contract.ISqlMaterializer).ExecuteTable(sqlProcedure))
            {
                dataSet = new DataSet(nameof(SqlMaterializer));
                dataSet.Tables.Add(dataTable);
            }
