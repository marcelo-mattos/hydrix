...
namespace Hydrix.UnitTests.Orchestrator.Materializers
{
    ...
    public partial class MaterializerTests
    {
        ...
        public void ExecuteTable_WithSqlAndParameters_ReturnsDataTable()
        {
            ...
            var result = (materializer as IMaterializer).ExecuteTable("SELECT * FROM Test", new { });
        ...
        public void ExecuteTable_WithSqlParametersAndTransaction_ReturnsDataTable()
        {
            ...
            var result = (materializer as IMaterializer).ExecuteTable("SELECT * FROM Test", new { }, transaction);
        ...
        public void ExecuteTable_WithSqlOnly_ReturnsDataTable()
        {
            ...
            var result = (materializer as IMaterializer).ExecuteTable("SELECT * FROM Test");
        ...
        public void ExecuteTable_WithSqlAndTransactionOnly_ReturnsDataTable()
        {
            ...
            var transaction = new Mock<IDbTransaction>().Object;
            var result = (materializer as IMaterializer).ExecuteTable("SELECT * FROM Test", transaction);
        ...
        public void ExecuteTable_WithCommandTypeSqlAndParameters_ReturnsDataTable()
        {
            ...
            var result = (materializer as IMaterializer).ExecuteTable(CommandType.Text, "SELECT * FROM Test", parameters);
        ...
        public void ExecuteTable_WithCommandTypeSqlParametersAndTransaction_ReturnsDataTable()
        {
            ...
            var parameters = new List<IDataParameter>();
            var transaction = new Mock<IDbTransaction>().Object;
            var result = (materializer as IMaterializer).ExecuteTable(CommandType.Text, "SELECT * FROM Test", parameters, transaction);
        ...
        public void ExecuteTable_WithCommandTypeAndSqlOnly_ReturnsDataTable()
        {
            ...
            var result = (materializer as IMaterializer).ExecuteTable(CommandType.Text, "SELECT * FROM Test");
        ...
        public void ExecuteTable_WithCommandTypeSqlAndTransactionOnly_ReturnsDataTable()
        {
            ...
            var transaction = new Mock<IDbTransaction>().Object;
            var result = (materializer as IMaterializer).ExecuteTable(CommandType.Text, "SELECT * FROM Test", transaction);
        ...
        public async Task ExecuteTableAsync_WithoutSqlParameters_ReturnsDataTable()
        {
            ...
            var result = await (materializer as IMaterializer).ExecuteTableAsync("SELECT * FROM Test", 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithSqlParameters_ReturnsDataTable()
        {
            ...
            var result = await (materializer as IMaterializer).ExecuteTableAsync("SELECT * FROM Test", new { }, 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithSqlParametersAndTransaction_ReturnsDataTable()
        {
            ...
            var transaction = new Mock<IDbTransaction>().Object;
            var result = await (materializer as IMaterializer).ExecuteTableAsync("SELECT * FROM Test", new { }, transaction, 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithSqlOnly_ReturnsDataTable()
        {
            ...
            var result = await (materializer as IMaterializer).ExecuteTableAsync("SELECT * FROM Test", CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithSqlAndTransactionOnly_ReturnsDataTable()
        {
            ...
            var transaction = new Mock<IDbTransaction>().Object;
            var result = await (materializer as IMaterializer).ExecuteTableAsync("SELECT * FROM Test", transaction, 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithCommandTypeSqlParameters_ReturnsDataTable()
        {
            ...
            var parameters = new List<IDataParameter>();
            var result = await (materializer as IMaterializer).ExecuteTableAsync(CommandType.Text, "SELECT * FROM Test", parameters, 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithCommandTypeSqlParametersAndTransaction_ReturnsDataTable()
        {
            ...
            var parameters = new List<IDataParameter>();
            var transaction = new Mock<IDbTransaction>().Object;
            var result = await (materializer as IMaterializer).ExecuteTableAsync(CommandType.Text, "SELECT * FROM Test", parameters, transaction, 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithCommandTypeAndSqlOnly_ReturnsDataTable()
        {
            ...
            var result = await (materializer as IMaterializer).ExecuteTableAsync(CommandType.Text, "SELECT * FROM Test", 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithCommandTypeSqlAndTransactionOnly_ReturnsDataTable()
        {
            ...
            var transaction = new Mock<IDbTransaction>().Object;
            var result = await (materializer as IMaterializer).ExecuteTableAsync(CommandType.Text, "SELECT * FROM Test", transaction, 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithProcedure_ReturnsDataTable()
        {
            ...
            var result = await (materializer as IMaterializer).ExecuteTableAsync<FakeDataParameter>(new TestProcedure(), 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_WithProcedureAndTransaction_ReturnsDataTable()
        {
            ...
            var result = await (materializer as IMaterializer).ExecuteTableAsync<FakeDataParameter>(new TestProcedure(), new FakeDbTransaction(), 30, CancellationToken.None);
        ...
        public async Task ExecuteTableAsync_OperationCanceled_ThrowsOperationCanceledException()
        {
            ...
            await Assert.ThrowsAsync<TaskCanceledException>(() =>
                (materializer as IMaterializer).ExecuteTableAsync("SELECT * FROM Test", new { }, 30, new CancellationToken(true)));
        }
    }
}
