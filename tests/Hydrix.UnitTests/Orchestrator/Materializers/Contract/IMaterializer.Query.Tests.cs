...
namespace Hydrix.UnitTests.Orchestrator.Materializers.Contract
{
    ...
    /// </summary>
    /// <remarks>These tests ensure that the IMaterializer interface and its implementations correctly
    ...
    public partial class IMaterializerTests
    {
        ...
        /// <summary>
        /// Verifies that calling the Query method on a disposed IMaterializer instance throws an
