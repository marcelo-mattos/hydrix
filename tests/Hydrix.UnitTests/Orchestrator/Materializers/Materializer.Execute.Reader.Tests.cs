...
{
    /// <summary>
    /// Contains unit tests for the IMaterializer interface, verifying correct behavior of data reader execution
    ...
    /// IMaterializer implementation correctly returns data readers and handles cancellation and exceptions as
    /// expected.</remarks>
    public partial class MaterializerTests
    {
        ...
        /// <summary>
        /// Verifies that the ExecuteReader method of IMaterializer returns the expected IDataReader when called with
        ...
        /// </summary>
        /// <remarks>This test ensures that the IMaterializer.ExecuteReader method correctly passes the
        ...
        /// statement.
        /// </summary>
        /// <remarks>This test ensures that the IMaterializer.ExecuteReader method correctly invokes
        ...
        /// <summary>
        /// Verifies that the ExecuteReaderAsync method of IMaterializer returns the expected IDataReader when
        ...
        /// </summary>
        /// <remarks>This test ensures that the IMaterializer.ExecuteReaderAsync method correctly
        ...
        /// </summary>
        /// <remarks>This test ensures that the ExecuteReaderAsync method of IMaterializer correctly
        ...
        /// reader instance.
        /// </summary>
        /// <remarks>This test ensures that the ExecuteReader&lt;TParameter&gt; method of IMaterializer
        ...
        /// data reader instance.
        /// </summary>
        /// <remarks>This test ensures that the IMaterializer.ExecuteReaderAsync&lt;T&gt; method correctly
