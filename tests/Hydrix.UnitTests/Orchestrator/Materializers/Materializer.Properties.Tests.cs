...
{
    /// <summary>
    /// Contains unit tests for the Materializer class, verifying its public properties and behaviors.
    /// </summary>
    /// <remarks>These tests ensure that Materializer correctly exposes its connection, transaction, state,
    ...
    public partial class MaterializerTests
    {
        ...
        public void DbTransaction_ReturnsInjectedTransaction()
        {
            ...
            Assert.Same(mockTran, typeof(Materializer)
