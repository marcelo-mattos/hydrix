...
{
    /// <summary>
    /// Contains unit tests for the Materializer class, verifying its behavior when executing non-query SQL commands
    /// synchronously and asynchronously with various parameter and transaction configurations.
    /// </summary>
    /// <remarks>These tests ensure that Materializer correctly handles different command types, parameter
