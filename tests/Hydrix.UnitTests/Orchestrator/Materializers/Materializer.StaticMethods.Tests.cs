    ...
    public partial class MaterializerTests
    {
        ...
        public void ConvertDataReaderToEntities_Null_Throws()
        {
            Assert.Throws<ArgumentNullException>(() =>
                Materializer.ConvertDataReaderToEntities<TestEntity>(null));
        }
        ...
        public void ConvertDataTableToEntity_ReturnsEntities()
        {
            ...
            var entities = Materializer.ConvertDataTableToEntity<TestEntity>(table);
        ...
        {
            var entities = Materializer.ConvertDataTableToEntity<TestEntity>(null);
        ...
        /// Materializer.ConvertEntityToDataTable contains the expected columns but does not include any data rows
        /// when the input collection is empty.</remarks>
        [Fact]
        public void ConvertEntityToDataTable_Empty_ReturnsSchemaOnly()
        {
            var table = Materializer.ConvertEntityToDataTable(new List<TestEntity>());
        ...
        {
            var table = Materializer.ConvertEntityToDataTable<TestEntity>(null);
