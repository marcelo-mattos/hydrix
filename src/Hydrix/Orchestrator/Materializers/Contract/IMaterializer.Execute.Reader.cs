...
{
    /// <summary>
    /// Defines a contract for executing SQL commands against a data source and retrieving results using an IDataReader.
    /// Provides synchronous and asynchronous methods for executing queries with support for command types, parameters,
    /// transactions, and cancellation tokens.
    /// </summary>
    /// <remarks>Implementations of this interface are responsible for managing the underlying database
    /// connection and ensuring proper disposal of resources. The interface supports a variety of overloads to
    /// accommodate different command execution scenarios, including parameterized queries, stored procedures, and
    /// transactional operations. Asynchronous methods enable non-blocking database access and support cancellation via
    /// CancellationToken. Callers should ensure that IDataReader instances returned by these methods are properly
    /// disposed after use to release database resources.</remarks>
