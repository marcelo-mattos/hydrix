...
namespace Hydrix.Orchestrator.Materializers
{
        ...
        Contract.ISqlMaterializer
    {
        ...
        DataTable Contract.ISqlMaterializer.ExecuteTable(
            ...
            object parameters)
        {
            using IDataReader dataReader = (this as Contract.ISqlMaterializer)
                .ExecuteReader(
                    sql,
                    parameters);
        ...
        {
            using var dataReader = await (this as Contract.ISqlMaterializer)
                .ExecuteReaderAsync(
                    sql,
                    parameters,
                    cancellationToken)
            ...
            ISqlProcedure<TDataParameterDriver> sqlProcedure)
        {
            ...
            using var dataReader = (this as Contract.ISqlMaterializer)
                .ExecuteReader(
                    sqlProcedure);
